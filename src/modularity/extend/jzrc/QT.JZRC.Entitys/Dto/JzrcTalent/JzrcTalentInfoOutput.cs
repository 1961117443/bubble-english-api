...
/// 人才信息输出参数.
/// </summary>
public class JzrcTalentInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 人才证书.
    /// </summary>
    public List<JzrcTalentCertificateInfoOutput> jzrcTalentCertificateList { get; set; }

    /// <summary>
    /// 人才沟通记录.
    /// </summary>
    public List<JzrcTalentCommunicationInfoOutput> jzrcTalentCommunicationList { get; set; }

    /// <summary>
    /// 人才合同
    /// </summary>
    public List<JzrcContractListOutput> jzrcTalentContractList { get; set; }
    ...
    /// 交接记录
    /// </summary>
    public List<JzrcTalentHandoverInfoOutput> jzrcTalentHandoverList { get; set; }

    /// <summary>
    /// 人才需求
    /// </summary>
    public List<JzrcTalentDemandListOutput> jzrcTalentDemandList { get; set; }
