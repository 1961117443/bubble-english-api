...
namespace QT.Iot.Application.Dto.CrmUserMarket;

/// <summary>
/// 我的部门
/// </summary>
public class CrmUserMarketOutput
{
    ///// <summary>
    ///// 个人累计业绩
    ///// </summary>
    ...
    /// 下级业务员
    /// </summary>
    public List<CrmUserMarketerOutput> crmUserMarketers { get; set; }

    /// <summary>
    /// 我的订单列表
    /// </summary>
    public List<CrmUserMarketerOrderOutput> myOrderList { get; set; }
...
public class CrmUserMarketerOutput
{
...
public class CrmUserMarketerOrderOutput: CrmOrderListOutput
{
