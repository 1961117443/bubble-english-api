...
/// 商品信息修改输入参数.
/// </summary>
public class ErpProductCrInput
{
    /// <summary>
    /// 分类ID.
    /// </summary>
    ...
    /// 商品规格.
    /// </summary>
    public List<ErpProductmodelCrInput> erpProductmodelList { get; set; }

    /// <summary>
    /// 商品图片.
    /// </summary>
    public List<ErpProductpicCrInput> erpProductpicList { get; set; }

    /// <summary>
    /// 商品视频.
    /// </summary>
    public List<ErpProductvideoCrInput> erpProductvideoList { get; set; }
    ...
    /// 商品关联公司.
    /// </summary>
    public List<ErpProductcompanyCrInput> erpProductcompanyList { get; set; }
