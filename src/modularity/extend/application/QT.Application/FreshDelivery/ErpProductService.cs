...
/// 业务实现：商品信息.
/// </summary>
[ApiDescriptionSettings("生鲜配送", Tag = "商品信息", Name = "ErpProduct", Order = 200)]
[Route("api/apply/FreshDelivery/[controller]")]
public class ErpProductService : IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
    ...
    public async Task Create([FromBody] ErpProductCrInput input)
    {
        ...
        //    _db.BeginTran();
            ...
            if (erpProductcompanyEntityList != null)
            {
                ...
                await _repository.Context.Insertable<ErpProductcompanyEntity>(erpProductcompanyEntityList).EnableDiffLogEvent($"{mainLogKey}:{nameof(ErpProductcompanyEntity)}").ExecuteCommandAsync();
            }
            ...
            {
                await _repository.Context.Insertable<ErpProductcompanyEntity>(modelProductcompanyEntityList).EnableDiffLogEvent($"{mainLogKey}:{nameof(ErpProductcompanyEntity)}").ExecuteCommandAsync();
            }
    ...
    public async Task Update(string id, [FromBody] ErpProductUpInput input)
    {
        ...
        //    _db.BeginTran();
            ...
            if (modelProductcompanyEntityList.IsAny())
            {
                ...
                await _repository.Context.Insertable<ErpProductcompanyEntity>(modelProductcompanyEntityList).EnableDiffLogEvent($"{nameof(ErpProductEntity)}:{entity.Id}:{nameof(ErpProductcompanyEntity)}").ExecuteCommandAsync();
            }
            ...
            if (erpProductpicEntityList != null)
            {
                ...
                await _repository.Context.Insertable<ErpProductpicEntity>(erpProductpicEntityList).EnableDiffLogEvent($"{nameof(ErpProductEntity)}:{entity.Id}:{nameof(ErpProductpicEntity)}").ExecuteCommandAsync();
            }
            ...
            if (erpProductvideoEntityList != null)
            {
                ...
                await _repository.Context.Insertable<ErpProductvideoEntity>(erpProductvideoEntityList).EnableDiffLogEvent($"{nameof(ErpProductEntity)}:{entity.Id}:{nameof(ErpProductvideoEntity)}").ExecuteCommandAsync();
            }
            ...
            if (erpProductcompanyEntityList != null)
            {
                ...
                await _repository.Context.Insertable<ErpProductcompanyEntity>(erpProductcompanyEntityList).EnableDiffLogEvent($"{nameof(ErpProductEntity)}:{entity.Id}:{nameof(ErpProductcompanyEntity)}").ExecuteCommandAsync();
            }
    ...
    public async Task<dynamic> ImportData(IFormFile file)
    {
        ...
        try
        {
            ...
            if (erpProductcompanyEntitys.IsAny())
            {
                ...
                await _repository.Context.Insertable<ErpProductcompanyEntity>(erpProductcompanyEntitys).EnableDiffLogEvent().ExecuteCommandAsync();
            }
            // 关闭事务
            _db.CommitTran();
    ...
    public async Task ErpProductcustomertypepriceBatchSave([FromRoute] string id, [FromBody] ErpProductcustomertypepriceBatchSaveInput input)
    {
        ...
        try
        {
            ...
            if (upList.Any())
            {
                await _repository.Context.Updateable<ErpProductcustomertypepriceEntity>(upList)
            ...
            if (addList.Any())
            {
                ...
                await _repository.Context.Insertable<ErpProductcustomertypepriceEntity>(addList)
    ...
    public async Task ErpCustomerBatchSave([FromRoute] string id, [FromBody] ErpProductCustomerpriceBatchSaveInput input)
    {
        ...
        try
        {
            ...
            if (upList.Any())
            {
                await _repository.Context.Updateable<ErpProductpriceEntity>(upList)
                     .IgnoreColumns(ignoreAllNullColumns: true)
                     .ExecuteCommandAsync();
            }
            ...
            if (addList.Any())
            {
                ...
                await _repository.Context.Insertable<ErpProductpriceEntity>(addList)
                    .IgnoreColumns(ignoreNullColumn: true)
                    .ExecuteCommandAsync();
            }
