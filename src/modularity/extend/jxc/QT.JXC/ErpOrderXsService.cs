...
/// 业务实现：订单信息.
/// </summary>
[ApiDescriptionSettings(ModuleConst.ERP, Tag = "Erp", Name = "ErpOrderXs", Order = 200)]
[Route("api/Erp/[controller]")]
public class ErpOrderXsService : IErpOrderXsService, IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
