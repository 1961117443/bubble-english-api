...
/// 业务实现：付款单.
/// </summary>
[ApiDescriptionSettings(ModuleConst.ERP,Tag = "Erp", Name = "CwPayment", Order = 200)]
[Route("api/Erp/[controller]")]
public class CwPaymentService : ICwPaymentService, IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
    ...
    public async Task Create([FromBody] CwPaymentCrInput input)
    {
        ...
        //    _db.BeginTran();
            ...
            if(cwPaymentDetailEntityList != null)
            {
                ...
                await _repository.Context.Insertable(cwPaymentDetailEntityList).ExecuteCommandAsync();
            }
