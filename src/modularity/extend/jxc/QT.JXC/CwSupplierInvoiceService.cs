...
using QT.JXC.Entitys.Dto.CwSupplierInvoice;
...
/// 业务实现：供应商发票记录.
/// </summary>
[ApiDescriptionSettings(ModuleConst.ERP,Tag = "Erp", Name = "CwSupplierInvoice")]
    ...
    public async Task Create([FromBody] CwSupplierInvoiceCrInput input)
    {
        ...
        //    _db.BeginTran();
            ...
            if(cwSupplierInvoiceDetailEntityList != null)
            {
                ...
                await _repository.Context.Insertable(cwSupplierInvoiceDetailEntityList).ExecuteCommandAsync();
            }
