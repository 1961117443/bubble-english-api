...
using QT.JXC.Entitys.Dto.Erp.ErpProductcheckMaster;
...
/// 业务实现：盘点记录主表.
/// </summary>
[ApiDescriptionSettings(ModuleConst.ERP, Tag = "Erp", Name = "ErpProductcheckMaster", Order = 200)]
[Route("api/Erp/[controller]")]
public class ErpProductcheckMasterService : IErpProductcheckMasterService, IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
    ...
    public async Task Create([FromBody] ErpProductcheckMasterCrInput input)
    {
        ...
        if (erpProductcheckEntityList != null)
        {
            ...
            await _repository.Context.Insertable(erpProductcheckEntityList).ExecuteCommandAsync();
        }
