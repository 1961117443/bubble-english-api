...
using QT.JXC.Entitys.Dto.ErpOrderdetailReject;
...
/// 业务实现：订单退货.
/// </summary>
[ApiDescriptionSettings(Tag = "Erp", Name = "ErpOrderdetailReject", Order = 200)]
[Route("api/Erp/[controller]")]
public class ErpOrderdetailRejectService : IErpOrderdetailRejectService, IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
