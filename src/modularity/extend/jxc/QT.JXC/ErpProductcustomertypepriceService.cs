...
using QT.JXC.Entitys.Dto.Erp.ErpProductcustomertypeprice;
...
/// 业务实现：商品客户类型定价.
/// </summary>
[ApiDescriptionSettings(ModuleConst.ERP, Tag = "Extend.Erp", Name = "ErpProductcustomertypeprice", Order = 200)]
[Route("api/Erp/[controller]")]
public class ErpProductcustomertypepriceService : IErpProductcustomertypepriceService, IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
