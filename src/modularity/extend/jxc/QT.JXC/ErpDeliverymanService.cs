...
/// 业务实现：送货员.
/// </summary>
[ApiDescriptionSettings(ModuleConst.ERP, Tag = "Erp", Name = "ErpDeliveryman", Order = 200)]
[Route("api/Erp/[controller]")]
public class ErpDeliverymanService : IErpDeliverymanService, IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
