...
/// 业务实现：订单信息.
/// </summary>
[ApiDescriptionSettings(ModuleConst.ERP, Tag = "Erp", Name = "ErpOrderCw", Order = 200)]
[Route("api/Erp/[controller]")]
public class ErpOrderCwService : IErpOrderCwService, IDynamicApiController, ITransient
{
    /// <summary>
    /// 服务基础仓储.
    /// </summary>
