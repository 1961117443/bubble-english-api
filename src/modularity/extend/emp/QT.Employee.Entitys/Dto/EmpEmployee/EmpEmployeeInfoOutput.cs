...
/// 员工档案输出参数.
/// </summary>
public class EmpEmployeeInfoOutput
{
    /// <summary>
    /// 主键.
    /// </summary>
    ...
    /// 员工学历.
    /// </summary>
    public List<EmpEmployeeEduInfoOutput> empEmployeeEduList { get; set; }

    /// <summary>
    /// 员工家庭信息.
    /// </summary>
    public List<EmpEmployeeFamilyInfoOutput> empEmployeeFamilyList { get; set; }

    /// <summary>
    /// 员工紧急联系人.
    /// </summary>
    public List<EmpEmployeeUrgentInfoOutput> empEmployeeUrgentList { get; set; }

    /// <summary>
    /// 员工变动记录
    /// </summary>
    public List<EmpEmployeeChangeLogOutput> empEmployeeChangeList { get; set; }
...
public class EmpEmployeeProfileInfoOutput: EmpEmployeeInfoOutput
{
    /// <summary>
    /// 是否离职
    /// </summary>
    public bool isDismission { get; set; }
...
public class EmpEmployeeChangeLogOutput
{
    /// <summary>
    /// 业务时间
    /// </summary>
