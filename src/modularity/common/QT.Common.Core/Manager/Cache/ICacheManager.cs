...
public interface ICacheManager
{
    ...
    /// <returns></returns>
    Task<T> GetOrCreateAsync<T>(string key, Func<CacheManagerEntryOptions, Task<T>> func);
    ...
    /// <param name="key"></param>
    /// <returns></returns>
    T GetOrCreate<T>(string key, Func<CacheManagerEntryOptions, T> func);
}

public class CacheManagerEntryOptions
{
