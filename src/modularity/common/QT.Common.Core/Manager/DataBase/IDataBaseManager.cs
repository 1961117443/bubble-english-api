...
public interface IDataBaseManager
{
    ...
    SqlSugarClient ChangeDataBase(DbLinkEntity link);
    ...
    /// <param name="link">数据连接.</param>
    /// <returns></returns>
    List<DbTableInfo> GetViewInfos(DbLinkEntity link);
    List<IConditionalModel> GetSqlCondition(VisualDevModelListQueryInput pageInput, MainBeltViceQueryModel columnDesign);
}