...
public enum ErrorCode
{
    ...
    /// 测试数据禁止更改admin密码.
    /// </summary>
    [ErrorCodeItemMetadata($"测试数据禁止更改用户【{CommonConst.SUPPER_ADMIN_ACCOUNT}】密码")]
    D1005,
    ...
    /// 数据库异常，请联系管理员！.
    /// </summary>
    [ErrorCodeItemMetadata("数据库异常，请联系管理员！")]
    D1032,
    ...
    /// 该角色没有关联组织，角色切换失败.
    /// </summary>
    [ErrorCodeItemMetadata("该角色没有关联组织，角色切换失败")]
    D1616,
    #endregion
