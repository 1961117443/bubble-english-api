...
namespace QT.Common.Models.User
{
    /// <summary>
    /// 登录者信息
    /// </summary>
    ...
    public class UserInfoModel
    {
        ...
        public List<CompanyInfoModel> companys { get; set; }

        /// <summary>
        /// 当前用户拥有的角色集合
        /// </summary>
        public List<BaseKVModel> roles { get; set; }
    ...
    [SuppressSniffer]
    public class CompanyInfoModel: BaseKVModel
    {
