...
public interface IUsersService
{
    ...
    Task InnerCreate([FromBody] UserInCrInput input);
    Task InnerCreateOrUpdate(UserInCrInput input);
    Task<List<OrganizeEntity>> GetRelationOrganizeList(string id);
    string GetUserName(UserEntity entity, bool isAccount = true);
}