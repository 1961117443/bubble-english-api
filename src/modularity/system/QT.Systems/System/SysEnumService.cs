...
/// 系统枚举服务
/// </summary>
[ApiDescriptionSettings(Tag = "System", Name = "Enum", Order = 211)]
...
public class SysEnumService: IDynamicApiController, ITransient
{
    ...
    {
        var enumTypeList = App.EffectiveTypes.Where(t => t.IsEnum && t.FullName.StartsWith("QT.")).ToList();
    ...
    {
        // 获取实体类型属性
        Type entityType = App.EffectiveTypes.FirstOrDefault(t => t.Name == input.EntityName) ?? throw Oops.Oh("该实体不存在");
