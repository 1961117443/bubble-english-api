...
using QT.UnifyResult.Internal;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;
using Microsoft.AspNetCore.Mvc.Filters;

namespace QT.UnifyResult;
...
public class RESTfulResultProvider : IUnifyResultProvider
{
    ...
    {
        var apiType = context.HttpContext.Request.Headers.Keys.Contains("QT_API");
        if (apiType)
        {
    ...
    public async Task OnResponseStatusCodes(HttpContext context, int statusCode, UnifyResultSettingsOptions unifyResultSettings)
    {
        ...
        switch (statusCode)
        {
            ...
            case StatusCodes.Status401Unauthorized:
                await context.Response.WriteAsJsonAsync(RESTfulResult(600, errors: "登录过期,请重新登录"), App.GetOptions<JsonOptions>()?.JsonSerializerOptions);
                break;
            // 处理 403 状态码
