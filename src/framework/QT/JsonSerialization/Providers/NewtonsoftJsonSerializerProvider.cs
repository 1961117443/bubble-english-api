...
namespace QT.JsonSerialization;
...
public class NewtonsoftJsonSerializerProvider : IJsonSerializerProvider, ISingleton
{
    ...
    /// <param name="jsonSerializerOptions"></param>
    /// <returns></returns>
    public object Deserialize(string json, object jsonSerializerOptions = null)
    {
        return JsonConvert.DeserializeObject<object>(json, (jsonSerializerOptions ?? GetSerializerOptions()) as JsonSerializerSettings);
    }
